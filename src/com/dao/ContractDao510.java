...
public class ContractDao510 {
    ...
    public Contract510 find(int id) throws SQLException {
        QueryRunner runner = new QueryRunner(C3p0Utils510.getDataSource());
        String sql = "select * from Contract510 where con_id=?";
    ...
    public Boolean insert(Contract510 c) throws SQLException{
        QueryRunner runner = new QueryRunner(C3p0Utils510.getDataSource());
        String sql="insert into Contract510(con_id,house_id,mid_id,seller_id,buyer_id,house_price,house_pm,loan_quota,loan_type) values (?,?,?,?,?,?,?,?,?)";
    ...
    public Boolean update(Contract510 c) throws SQLException {
        QueryRunner runner = new QueryRunner(C3p0Utils510.getDataSource());
        String sql="update Contract510 set house_id=?,mid_id=?,seller_id=?,buyer_id=?,house_price=?,house_pm=?,loan_quota=?,loan_type=? where con_id=?";
    ...
    public Boolean delete(int id) throws SQLException {
        QueryRunner runner = new QueryRunner(C3p0Utils510.getDataSource());
        String sql="delete from Contract510 where con_id=?";
